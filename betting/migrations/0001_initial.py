    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', django_fsm.FSMField(choices=[('pendiente', 'Pendiente'), ('aceptada', 'Aceptada'), ('ganada', 'Ganada'), ('perdida', 'Perdida'), ('anulada', 'Anulada'), ('cash_out', 'Cash-out')], default='aceptada', max_length=50, protected=True, verbose_name='Estado')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', django_fsm.FSMField(choices=[('pendiente', 'Pendiente'), ('aceptada', 'Aceptada'), ('ganada', 'Ganada'), ('perdida', 'Perdida'), ('anulada', 'Anulada'), ('cash_out', 'Cash-out')], default='aceptada', max_length=50, protected=True)),
                ('creado_en', models.DateTimeField(auto_now_add=True)),
                ('actualizado_en', models.DateTimeField(auto_now=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', django_fsm.FSMField(choices=[('programado', 'Programado'), ('en_vivo', 'En vivo'), ('finalizado', 'Finalizado'), ('suspendido', 'Suspendido'), ('anulado', 'Anulado')], default='programado', max_length=50, protected=True, verbose_name='Estado')),
                ('creado_en', models.DateTimeField(auto_now_add=True)),
                ('actualizado_en', models.DateTimeField(auto_now=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo', models.CharField(choices=[('1X2', '1X2 (Gana local / Empate / Gana visitante)'), ('over_under', 'Over/Under 2.5 goles'), ('btts', 'Ambos equipos anotan (BTTS)'), ('handicap', 'Hándicap asiático simple'), ('goleador', 'Goleador exacto')], max_length=20, verbose_name='Tipo de mercado')),
